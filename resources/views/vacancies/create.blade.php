            ...
            <div>
                <label for="title">
                    ...
                    <input type="text" id="title"
                        ...
                        name="title" placeholder="ex. Senior Web Developer" value="{{ old('title') }}" />
            ...
            <div>
                <label for="company">
                    ...
                    <input type="text" id="company"
                        class="mt-0.5 p-2 w-full rounded border border-gray-300 shadow-sm bg-white sm:text-sm"
                        name="company" placeholder="ex. Apple Inc." value="{{ old('company') }}" />
            ...
            <div>
                <label for="location">
                    ...
                    <input type="text" id="location"
                        class="mt-0.5 p-2 w-full rounded border border-gray-300 shadow-sm bg-white sm:text-sm"
                        name="location" placeholder="ex. San Francisco, CA" value="{{ old('location') }}" />
