@if (session()->has('message'))
    <div role="alert" x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)" x-show="show"
        class="rounded-md border border-gray-300 bg-white p-4 shadow-sm fixed bottom-0 left-1/2 transform -translate-x-1/2">
